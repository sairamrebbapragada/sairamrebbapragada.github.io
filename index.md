...
Broadly, I like building visual perception systems that do not just work in clean benchmark settings, but remain reliable when deployed in real-world conditions: tiny objects, long-tailed data, limited labels, domain shifts, and real-time constraints. My work spans GUI agents, MLLM safety/unlearning, mechanistic interpretability, aerial/drone perception, object detection under distribution shifts, source-free adaptation, and efficient deployment. Selected publications include ECCV 2026, CVPR 2026, ICRA 2024, and WACV 2023. 
